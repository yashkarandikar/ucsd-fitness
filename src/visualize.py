...
def get_avg_data(infile, x_params, y_params):
    """
    Plots data averaged over each workout. For each i, plots y_params[i] vs x_params[i] averaged over each workout. Thus each point in the plot corresponds to one workout
...
if __name__ == "__main__":
    ...
    parser.add_argument('--infile', type=str, help='.gz file containing all workouts', dest='infile')
