...
def prepare(infile, outfile, mode):
    sport = "Running"
    params = ["workout_id", "distance", "pace", "duration"]
...
if __name__ == "__main__":
    ...
    [mse, var, fvu, r2, errors] = compute_stats(train_set[:, param_indices["pace"]], train_pred)
    ...
    [mse, var, fvu, r2, errors] = compute_stats(val_set[:, param_indices["pace"]], val_pred)
